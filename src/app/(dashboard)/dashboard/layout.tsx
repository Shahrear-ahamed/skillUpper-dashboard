...
export default function Layout() {
  return (
    <SidebarProvider className="bg-gray-100">
      ...
      <Button
        variant="secondary"
        className="shadow-lg hover:bg-gray-400 px-0 p-3 h-12 absolute bottom-10 right-10"
        size="lg">
        <div className="bg-gray-300 flex items-center w-full space-x-2 px-2 py-1 rounded">
